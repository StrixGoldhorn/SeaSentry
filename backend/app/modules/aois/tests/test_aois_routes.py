...
# ==========================================
# Tests for POST/PATCH /api/v1/aois/update/<aoi_id>
# ==========================================
...
def test_update_aoi_by_id_success_name_desc(mock_update, mock_audit, client):
    ...
    response = client.post('/api/v1/aois/update/1', data={
...
def test_update_aoi_by_id_success_coords(mock_update, client):
    ...
    response = client.patch('/api/v1/aois/update/2', data={
        'coords': coords
    })
...
def test_update_aoi_by_id_success_bbox(mock_update, client):
    ...
    response = client.post('/api/v1/aois/update/3', data={
...
def test_update_aoi_by_id_not_found(mock_update, client):
    ...
    response = client.post('/api/v1/aois/update/999', data={
        'name': 'NewName'
    })
